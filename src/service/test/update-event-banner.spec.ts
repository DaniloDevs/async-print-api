...
describe("UpdateBannerEventService", () => {
   ...
   it("should be possible to update the banner for a lengthy event.", async () => {
      ...
      const updatedEvent = await eventRepository.findById(event?.id as string);

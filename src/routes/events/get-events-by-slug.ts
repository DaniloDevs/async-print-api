  ...
  app.withTypeProvider<ZodTypeProvider>().get(
    "/events/:slug",
    {
      schema: {
        ...
        tags: ["Events"],
        description:
          "Retrieves the details of a specific event using its unique, URL-friendly slug. This endpoint is typically used to render public-facing event pages and ensures SEO-friendly URLs.",
        params: z.object({
          slug: z.string(),
        }),
        response: {

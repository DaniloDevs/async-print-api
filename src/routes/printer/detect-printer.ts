                ...
                response: {
                    200: z.object({
                        success: z
                            .boolean()
                            .describe(
                                "Always true when a device is successfully detected.",
                            ),
                        path: z
                            .string()
                            .describe(
                                "The system path of the detected device (e.g., 'COM3', '/dev/usb/lp0').",
                            ),
                    ...
                    404: z.object({
                        ...
                        message: z
                            .string()
                            .describe("Explanation of why detection failed."),
                        tip: z
                            .string()
                            .optional()
                            .describe(

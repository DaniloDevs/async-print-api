    ...
    app.withTypeProvider<ZodTypeProvider>().get(
        ...
        async (request, reply) => {
            ...
            const totalRetentionRate =
                totalLeads === 0 ? 0 : (totalConversions / totalLeads) * 100;
                ...
                metrics: {
                    ...
                    leadsLastHour: {
                        ...
                        growthPercentage: Number(
                            leadsGrowthPercentage.toFixed(2),
                        ),
                    ...
                    conversionsPerHour: {
                        ...
                        growthPercentage: Number(
                            conversionGrowthPercentage.toFixed(2),
                        ),

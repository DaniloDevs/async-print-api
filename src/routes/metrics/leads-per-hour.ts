      ...
      .get(
         "/:eventSlug/metrics/leads-per-hour",
         {
            schema: {
               ...
               tags: ["Metrics"],
               description: "Generates a temporal histogram of lead capture activity. Data is grouped into 30-minute intervals within the event's start and end schedule. Ideal for visualizing traffic peaks and throughput over time.",
               params: z.object({
                  eventSlug: z.string()
               }),
               response: {
